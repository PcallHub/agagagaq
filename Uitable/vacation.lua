...
function Library:CreateWindow(Config, Parent)
	...
	function WindowInit:SetBackground(ImageId)
		Holder.Image = "rbxassetid://8192163394" .. ImageId
	end
	...
	RunService.RenderStepped:Connect(function()
		if Library.Toggle then
			Screen.ToolTip.Position = UDim2.new(0,UserInputService:GetMouseLocation().X + 5,0,UserInputService:GetMouseLocation().Y - 3)
		end
	end)
...
local Config = {
    WindowName = " HUB -- [  ]",
    Color = Color3.fromRGB(15, 93, 255),
...
Label1:UpdateText("moi ra nen nhieu bug")
-------------
